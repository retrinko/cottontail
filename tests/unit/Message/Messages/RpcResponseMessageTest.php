...
class RpcResponseMessageTest extends \PHPUnit_Framework_TestCase
{
    public function test_constructor_withProperParams_populateBodyAndPropertiesProperly()
    {
        ...
        $properties = [MessageInterface::PROPERTY_CORRELATION_ID => $correlationId,
                       MessageInterface::PROPERTY_CONTENT_TYPE => $contentType];
        ...
        $this->assertEquals(MessageInterface::TYPE_RPC_RESPONSE, $message->getType(),
                            sprintf('Type is not "%s"!', MessageInterface::TYPE_RPC_RESPONSE));
        // correlation id
